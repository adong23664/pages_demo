...
<?php
	...
	"\$pdo = new PDO('mysql:host=localhost; port=8889; dbname=proj; charset=utf8', <br>" .
    " 'root', 'root',<br>" .
	"array(<br>";
	...
	// 第一個參數($dsn)的格式：
	//  mysql:host=localhost; port=8889; dbname=proj; charset=utf8
...
//    	$pdo = new PDO('mysql:host=localhost; port=3307; dbname=proj; charset=utf8', 'root', 'root', 
